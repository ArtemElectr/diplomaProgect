...
label_encoder = LabelEncoder() # Закодируйте целевые метки со значением от 0 до n_классов-1.
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 6, 5) # параметры: 3 - Количество каналов во входном изображении, 6 - количество каналов, создаваемых свёрткой, 5 - размер ядра свёртки
        ...
        self.fc1 = nn.Linear(16 * 289 * 4, 1200) # Применяет аффинное линейное преобразование к входящим данным: y=xA^T+b.
